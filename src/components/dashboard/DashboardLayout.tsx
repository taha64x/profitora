...
function NavLink({ href, icon, label, active, special, collapsed }: {
  ...
  const base = 'flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all'
  const style = special
    ...
    return (
      <>
        ...
        <nav className="flex-1 px-3 py-4 overflow-y-auto space-y-0.5">
          ...
          {/* Wichtigster Wertpfad zuerst: Analyse-Funktionen direkt unter der Übersicht,
              damit sie ohne Scrollen erreichbar sind (Nav war zu lang). */}
          ...
          <NavLink href="/dashboard/forecast" icon="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"
            label="Forecast" active={active('/dashboard/forecast')} collapsed={collapsed && !mobile}/>
